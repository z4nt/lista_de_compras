...
export default function Cadastro({visible, setVisible, handleRefresh}) {
            ...
            {visible && (
                <div className="flex justify-center items-center h-screen">
                    <div className="bg-white w-[510px] sm:h-[450px] h-[600px] rounded-xl flex flex-col items-center py-8">
                        <div className="flex">
                        <h1 className="text-2xl font-bold mx-40">CADASTRO</h1>
                        <button className='w-4' onClick={handleClick}><img src="/close.svg" alt="" /></button>
                        </div>
                        <form onSubmit={handleSubmit}>
                            <div className="flex flex-col items-center">
                                ...
                                <button type="submit" onClick={handleRefresh} className="w-16 bg-green-400 hover:bg-green-500 mt-10 h-10 rounded-lg flex items-center justify-center px-2">
                                    +
                                </button>
                            </div>
                        </form>
